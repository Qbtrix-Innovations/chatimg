...
<Dialog.Root>
	<Dialog.Trigger>
		<Button class={clsx(' bg-transparent hover:bg-transparent rounded-full')}>
			<img
				alt="profile"
	...
	<Dialog.Content class="bg-card overflow-auto">
		<div class={clsx('w-full bg-card flex justify-between items-center p-4')}>
			<div class={clsx('flex flex-row justify-start items-center align-middle')}>
				<button on:click={back} class={clsx('bg-transparent hover:bg-transparent')}>
					<ArrowLeft class="w-6 mr-2 dark:text-white"  />
				</button>
		...
		<div class={clsx(' w-full bg-card ')}>
			...
			>
				<div class="font-bold leading-4 text-sm text-[#263238] dark:text-white/90 opacity-50">Subscriptions</div>
			...
			>
				<div class="flex flex-row gap-2 items-center align-middle justify-start">
					<div class="">
						<svg height="2em" class="dark:fill-white/80 fill-black" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
			...
			<div class="w-full flex justify-center mt-6">
				<div class={`justify-self-center grid w-[90%] self-center`}>
					<div
						class="font-bold text-sm leading-4 text-[#263238] dark:text-white/90 opacity-50 self-start justify-self-start"
					>
						Change Password
					</div>
					<Input
			...
			<div class="w-full flex justify-center relative mt-6">
				<div class="justify-self-center self-end w-[90%] grid mb-4">
					<div class="self-start flex flex-row align-middle items-center justify-between">
						<div class="font-bold leading-4 text-sm text-[#263238]/50 dark:text-white/90">Disable Account</div>
						<button
