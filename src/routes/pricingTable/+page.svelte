...
<div class={clsx('flex flex-col overflow-y-scroll mt-[5%] ml-[5%] mr-[5%]')}>
	<div class={clsx('font-semibold text-[22px] leading-[31.5px]')}>No Credits Left</div>
	<div class={clsx('font-semibold text-[16px] leading-[22px] text-[#959595] w-3/5 mt-[2%]')}>
		For more chats please buy one of the plans
	</div>
	<CustomCard
		icn={`<svg width="43" height="43" viewBox="0 0 43 43" fill="none" xmlns="http://www.w3.org/2000/svg">
				<path d="M21.5 14.3333V7.16666H14.3334" stroke="black" stroke-width="3.58333" stroke-linecap="round" stroke-linejoin="round"/>
				<path d="M32.25 14.3333H10.75C8.77094 14.3333 7.16663 15.9377 7.16663 17.9167V32.25C7.16663 34.229 8.77094 35.8333 10.75 35.8333H32.25C34.229 35.8333 35.8333 34.229 35.8333 32.25V17.9167C35.8333 15.9377 34.229 14.3333 32.25 14.3333Z" stroke="black" stroke-width="3.58333" stroke-linecap="round" stroke-linejoin="round"/>
				<path d="M3.58337 25.0833H7.16671" stroke="black" stroke-width="3.58333" stroke-linecap="round" stroke-linejoin="round"/>
				<path d="M35.8334 25.0833H39.4167" stroke="black" stroke-width="3.58333" stroke-linecap="round" stroke-linejoin="round"/>
				<path d="M26.875 23.2917V26.875" stroke="black" stroke-width="3.58333" stroke-linecap="round" stroke-linejoin="round"/>
				<path d="M16.125 23.2917V26.875" stroke="black" stroke-width="3.58333" stroke-linecap="round" stroke-linejoin="round"/>
			</svg>`}
		onClick={EnterYourOwnApiKey}
		h1={'Use your own API Key'}
		h2={`What You'll Get ?`}
		bullets={['Unlimited', 'Access to All our rooms']}
		price={0}
		unitTime={'day'}
		buttonText={'Start'}
	/>
    ...
    `}
		...
		buttonText={'Choose'}
	/>
	<form action="?/monthlySubscription" method="post">
		<CustomCard
			icn={`
    <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
        <g clip-path="url(#clip0_8155_67)">
