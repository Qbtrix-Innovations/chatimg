...
>
	...
	<div class="flex w-full h-full items-center -mt-10">
		<div
			class="2xl:w-3/6 w-5/6 md:w-3/6 lg:w-2/6 xl:w-5/6 mx-auto h-52 bg-white rounded-xl flex justify-center items-center border-2 border-dashed border-[rgba(200,200,200,1)]"
		>
			<label class="flex flex-col justify-center items-center">
				<ImagePlus size="46" color="#bcc7c7" stroke-width="2.5" />

				<div class="mt-2 text-base leading-normal text-center">
